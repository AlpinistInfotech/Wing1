...
namespace Database.Migrations
{
    ...
    [Migration("20210526174212_alter_table_tbl_tblregistration")]
    partial class alter_table_tbl_tblregistration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.tblHolidayPackageMaster", b =>
                {
                    ...
                    b.Property<DateTime>("PackageFromDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("PackageName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("PackageToDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("UploadOtherImage")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UploadPackageImage")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("tblHolidayPackageMaster");
                });
            ...
            modelBuilder.Entity("Database.tblTCInvoice", b =>
                {
                    b.Property<int>("DetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("tblTCinvoice");
                });

            modelBuilder.Entity("Database.tblTCMemberRank", b =>
                {
                    b.Property<int>("DetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("tblTCmemberrank");
                });

            modelBuilder.Entity("Database.tblTCMemberRankLog", b =>
                {
                    b.Property<int>("DetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("tblTCmemberranklog");
                });

            modelBuilder.Entity("Database.tblTCSaleSummary", b =>
                {
                    b.Property<int>("salesummaryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("TcNidlevelid")
                        .HasColumnType("int");

                    b.Property<int?>("TcSpNid")
                        .HasColumnType("int");

                    b.Property<int>("TcSpNidlevelid")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("tblRegistrationSpNid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("tblRegistrationSpNid");

                    b.ToTable("tblTCsalesummary");
                });

            modelBuilder.Entity("Database.tblTCStatement", b =>
                {
                    b.Property<int>("inentiveId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("incentivestatus")
                        .HasColumnType("int");

                    b.Property<int>("monthyear")
                        .HasColumnType("int");

                    b.Property<decimal>("netincentive")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("tblTCstatement");
                });

            modelBuilder.Entity("Database.tblTCStatementLog", b =>
                {
                    ...
                    b.Property<int>("incentive_status")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Database.tblTCStatus", b =>
                {
                    ...
                    b.Property<DateTime>("action_datetime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Database.tblTcMarkUp", b =>
                {
                    b.Property<int>("DetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Database.tblTCSaleSummary", b =>
                {
                    ...
                    b.HasOne("Database.tblRegistration", "tblRegistrationSp")
                        .WithMany()
                        .HasForeignKey("tblRegistrationSpNid");

                    b.Navigation("tblRegistration");

                    b.Navigation("tblRegistrationSp");
                });
